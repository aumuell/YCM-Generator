...
def main():
    ...
    parser.add_argument("-e", "--environment", action="store_true", help="Pass environment to fake build process")
...
def fake_build(project_dir, c_build_log_path, cxx_build_log_path, verbose, make_cmd, cc, cxx, out_of_tree, configure_opts, make_flags, environment):
    ...
    environment: pass environment to fake build process
    '''
